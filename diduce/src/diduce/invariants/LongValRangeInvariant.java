...
public class LongValRangeInvariant extends diduce.invariants.LongRangeInvariant {

public void newSample (Object ref, long new_val, long old_val, String spp_desc, int spp_num)
{
    newSample (new_val, spp_desc, get_description());
}

public String get_description () { return "range of values"; }
